package com.taskwebservice.apis;
...
import com.taskwebservice.model.CommentCollectionResource;
import com.taskwebservice.model.CommentResource;
...
public class CommentsService {
	...
	public CommentCollectionResource getCommentsForTask(String taskId) {
		...
		return restTemplate.getForObject(String.format("http://commentswebservice/comments/%s", taskId),
